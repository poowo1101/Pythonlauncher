...
[Функції](#-функції) • [Встановлення](#-встановлення) • [Використання](#-використання) • [Скріншоти](#-скріншоти)
...
### Спосіб 1: Готовий EXE (рекомендовано)
1. Завантажте останню версію з [Releases](https://github.com/poowo1101/Pythonlauncher/releases)
2. Запустіть `PythonLauncher.exe`
3. Готово!

### Спосіб 2: Запуск з вихідного коду
```bash
